    ...
    <Painel>
      <form onSubmit={e => void salvar(e)}>
        ...
        <fieldset disabled={enviando} className="formulario-chamado">
          ...
          <div className="acoes-linha acoes-formulario"><button type="submit">{enviando ? 'Salvando…' : ticket ? 'Salvar alterações' : 'Criar chamado'}</button><button type="button" className="secundario" onClick={aoCancelar}>Cancelar</button></div>
        </fieldset>
